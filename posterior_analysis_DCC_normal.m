...
function write_file = posterior_analysis_DCC_normal(draws, count, write_path, snap_dt, nof_z_vec)
% Inputs:
...
MH_para_name = [name_absum; name_ap; {'cd_sum'}; {'cp'}]; %name of the parameters that did MH steps
