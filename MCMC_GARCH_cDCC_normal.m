...
for i = 1:nof_total
    ...
    log_like = loglike_cDCC_normal(u, u2, para*cp, para-para*cp);
    log_like_prop = loglike_cDCC_normal(u, u2, para_prop*cp, para_prop-para_prop*cp);
    ...
    log_like = loglike_cDCC_normal(u, u2, para*cdsum, cdsum-para*cdsum);
    log_like_prop = loglike_cDCC_normal(u, u2, para_prop*cdsum, cdsum-para_prop*cdsum);
