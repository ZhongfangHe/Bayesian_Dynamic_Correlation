% Posterior analysis for DCC estimates
...
function write_file = posterior_analysis_VC_normal(draws, count, write_path, snap_dt, nof_z_vec)
% Inputs:
...
post_draws = [draws.a   draws.b    draws.e   draws.f];
for j = 1:m
...
MH_para_name = [name_absum; name_ap; {'efsum'}; {'ep'}]; %name of the parameters that did MH steps
count_mat = [count.absum   count.ap  count.efsum  count.ep]; %matrix of the counts of MH acceptance
