...
function loglike = loglike_BIGDC_normal_exact(u, u2, aq, bq, ar, br)
% Inputs:
...
mean_xmat = mean(x_mat);
mean_Xt = corr_vec2mat(mean_xmat',m); 
R0 = ((1-br) * matrix_normalize(R0_raw) - ar * mean_Xt) / (1 - ar - br);
