...
function write_file_pred = info_pred_cDCC_normal(logp_vec, pred_para_est, pred_mh, snap_dt, write_path) %store est info to check if anything goes wrong
...
para_name = [{'log_pred_density'}; name_absum; name_ap; {'cdsum'}; {'cp'}; name_ar_absum; name_ar_ap; {'AccptRate_cdsum'}; {'AccptRate_cp'}];
