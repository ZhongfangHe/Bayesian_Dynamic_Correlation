...
nof_burnin = 0; %number of burn-ins
nof_draws = 100; %number of effective draws for posterior analysis
...
nof_pred = 2; %nof_pred = 0 if only full-sample estimation is needed
